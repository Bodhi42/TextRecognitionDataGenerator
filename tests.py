...
class DataGenerator(unittest.TestCase):
    ...
    def test_generate_russian_string(self):
        s = create_strings_randomly(1, False, 1, True, False, False, "ru")[0]

        ru_chars = [chr(i) for i in range(1040, 1104)] + list("Ёё")

        self.assertTrue(all([l in ru_chars for l in s]))
